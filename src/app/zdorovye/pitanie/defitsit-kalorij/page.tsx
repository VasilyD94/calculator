...
export const metadata: Metadata = {
  title: 'Калькулятор похудения — за сколько похудею, расчёт онлайн',
  description:
    'Бесплатный калькулятор похудения ✓ Узнайте за сколько похудеете до цели ✓ График снижения веса ✓ Дефицит калорий ✓ Оценка безопасности. Без регистрации.',
  keywords: [
  ...
  openGraph: {
    title: 'Калькулятор похудения — за сколько похудею',
    description:
      'Узнайте за сколько похудеете до целевого веса. График прогресса и безопасный дефицит калорий.',
    type: 'website',
    ...
    <>
      ...
      <JsonLd
        data={{
          ...
          '@type': 'WebApplication',
          name: 'Калькулятор похудения',
          description:
            'Онлайн калькулятор похудения: узнайте за сколько похудеете до целевого веса, график прогресса и безопасный дефицит калорий',
