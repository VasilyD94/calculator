...
export const metadata: Metadata = {
  title: 'Идеальный вес — расчёт по росту и возрасту онлайн',
  description:
    'Узнайте свой идеальный вес бесплатно ✓ Расчёт по 5 формулам: Devine, Robinson, Miller, Hamwi и Брока ✓ Сравнение результатов ✓ Отклонение от нормы.',
  keywords: [
    'идеальный вес',
  ...
  openGraph: {
    title: 'Идеальный вес — расчёт по росту и возрасту',
    description:
