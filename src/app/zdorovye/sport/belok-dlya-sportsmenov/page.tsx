...
export const metadata: Metadata = {
  title: 'Норма белка в день — расчёт суточной потребности онлайн',
  description:
    'Рассчитайте норму белка в день бесплатно ✓ По рекомендациям ISSN и ACSM ✓ Сколько белка нужно в день для похудения и набора массы ✓ Распределение по приёмам пищи.',
  keywords: [
    'норма белка',
    'норма белка в день',
  ...
  openGraph: {
    title: 'Норма белка — расчёт суточной потребности',
    description:
